...
function ThreeDotMenu({ isCompleted, onEdit, onDelete, onComplete, onClose}) {
    ...
    <div ref={domref} className='absolute right-0 mt-2 w-32 bg-white text-[#434652] shadow-lg rounded-md border border-gray-200 z-10'>
        <div className="flex flex-col">
            ...
            <button
                ...
                className={`text-left px-4 py-2 ${isCompleted ? 'text-gray-400 cursor-not-allowed' : 'hover:bg-gray-100'}`}
            >
